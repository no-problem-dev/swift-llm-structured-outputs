...
enum APIKeyManager {
    ...
    private enum Keys {
        static let anthropic = "com.example.conversationagentexample.anthropic_api_key"
        static let openAI = "com.example.conversationagentexample.openai_api_key"
        static let gemini = "com.example.conversationagentexample.gemini_api_key"
        static let braveSearch = "com.example.conversationagentexample.brave_search_api_key"
    }
